...
|---|---|---|
| **#1 Versionado de 4 endpoints (GET/POST/PUT/DELETE)** | `src/main/java/.../controller/v2/` + 4 DTOs | `curl http://44.221.84.84:8080/api/v2/productos?page=0&size=2` |
...
| **#3 Despliegue en AWS** | [`DEPLOY.md`](DEPLOY.md) + [`deploy/user-data.sh`](deploy/user-data.sh) | Abrir `http://44.221.84.84:8080/swagger-ui/index.html` |
...
- **API**: `http://44.221.84.84:8080` (EC2 t3.small, Amazon Linux 2023, Docker Compose).
- **Swagger UI**: http://44.221.84.84:8080/swagger-ui/index.html
- **OpenAPI JSON**: http://44.221.84.84:8080/v3/api-docs
